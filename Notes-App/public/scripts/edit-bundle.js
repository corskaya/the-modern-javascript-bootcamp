...
var remove = document.querySelector('#remove-note');
var editInfo = document.querySelector('#edit-info');

(0, _views.initializeEditPage)(noteId);

noteTitle.addEventListener('input', function (e) {
  var note = (0, _notes.updateNote)(noteId, {
    title: e.target.value
  });
  editInfo.textContent = (0, _views.generateLastEdited)(note.updatedAt);
});
...
exports.updateNote = exports.sortNotes = exports.removeNote = exports.createNote = exports.getNotes = undefined;
...
// Read existings notes from localStorage
...
var sortNotes = function sortNotes(sortBy) {
  if (sortBy === 'byEdited') {
    ...
    return notes.sort(function (a, b) {
      if (a.title.toLowerCase() < b.title.toLowerCase()) return -1;else if (a.title.toLowerCase() > b.title.toLowerCase()) return 1;else return 0;
    });
  } else {
    return notes;
  }
...
var updateNote = function updateNote(id, updates) {
  ...
  if (typeof updates.title === 'string') {
    ...
    note.updatedAt = (0, _moment2.default)().valueOf();
  }
...
exports.initializeEditPage = exports.generateLastEdited = exports.renderNotes = exports.generateNoteDOM = undefined;
...
var generateNoteDOM = function generateNoteDOM(note) {
  ...
  textEl.classList.add('list-item-title');
...
var renderNotes = function renderNotes() {
  ...
  var notes = (0, _notes.sortNotes)(filters.sort);
...
var initializeEditPage = function initializeEditPage(noteId) {
  var titleElement = document.querySelector('#note-title');
  var bodyElement = document.querySelector('#note-body');
  var dateElement = document.querySelector('#edit-info');
...
var generateLastEdited = function generateLastEdited(timestamp) {
  return 'Last edited ' + (0, _moment2.default)(timestamp).fromNow();
};
...
/***/ 1:
/*!******************************************!*\
  !*** multi babel-polyfill ./src/edit.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/edit.js */"./src/edit.js");
